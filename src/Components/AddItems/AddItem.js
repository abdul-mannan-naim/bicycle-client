                            ...
                            <div className='my-2'>
                                <textarea
                                    {...register("description", {
                                        ...
                                        maxLength: {
                                            value: 55,
                                            message: " more than 55 Character"
                                        }
                                    })}
                                    class="textarea textarea-bordered " placeholder="Short description">
                                </textarea> <br />
                                <label  >   {errors.description?.type === "required" && <span> {errors.description.message} </span>}</label>
                                <label  >    {errors.description?.type === "maxLength" && <span> {errors.description.message} </span>}</label>
                            </div>
